...
BLOCKED_PATTERNS = [
    ...
    # Code execution (block dangerous eval/exec but allow safe ast.literal_eval)
    (r"os\.system\(", "Shell command execution"),
    (r"subprocess\.", "Subprocess execution"),
    # Only block standalone eval( ); ast.literal_eval() is safe for parsing literals
    (r"(?<!literal_)eval\s*\(", "Eval execution"),
    # Only block standalone exec( ); avoid matching .execute( on DB/cursor objects
